      ...
      {session ? (
        <form onSubmit={handleSubmit} className="mb-8">
          <div className="rounded-[1.25rem] border border-[#E8E4DC] bg-white overflow-hidden">
            ...
            <textarea
              ...
              className="
                w-full px-5 py-4 text-sm text-[#18181A] placeholder:text-[#C0BDB5]
            ...
            <div className="flex items-center justify-between px-5 py-3 border-t border-[#E8E4DC]">
              ...
              <button
                ...
                className="
                  ...
                  hover:bg-[#2A2A2C] active:scale-[0.97] disabled:opacity-40
        ...
        <div className="mb-8 rounded-[1.25rem] border border-[#E8E4DC] bg-[#F5F1E8] px-6 py-5 flex items-center justify-between gap-4 flex-wrap">
          ...
          <div className="flex items-center gap-3">
            <Link
              href={`/signin?from=/products/${productSlug}`}
              className="text-sm font-medium text-[#8A8A85] hover:text-[#18181A] transition-colors"
            >
              Sign in
            </Link>
            <Link
